...
<div class="catalog" data-catalog-id="<?=$template['id']?>">
    ...
    <div class="catalog-filters">
        <select name="category" id="category" class="catalog-filters-select category">
            <option class="filterValues" value="all" disabled style="display:none;"<?php if( !isset ($_GET['category'])) {echo " selected";}?>>Категория</option>
        ...
        <select name="size" id="size" class="catalog-filters-select size">
            <option class="filterValues" value="all" disabled style="display:none;"<?php if( !isset ($_GET['size'])){echo " selected";}?> >Размер</option>
        ...
        <select name="price" id="" class="catalog-filters-select price">
            <option value="all" disabled style="display:none;"<?php if( !isset ($_GET['priceMin'])){echo " selected";}?> >Стоимость</option>

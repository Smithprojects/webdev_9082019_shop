...
<?php 
//md_substr(сам текст, сдвиг от начала, кол-во символов,'utf-8') - функция ограничения вывода теста
//mb_substr($_GET['text'], 0, 50, 'utf-8') . ' ...';

//strip_tags() - удаляет вставки html из текста
//mb_substr(strip_tags($_GET['text']), 0, 50, 'utf-8');

//$_POST['do_post'] - ключ появляется при нажатиии кнопки отправки формы

//password_hash(пароль, PASSWORD_DEFAULT) - кодировка паролей
//password_verify() - дешифровние пароля

//var_dump() - выводит данные о объекте
